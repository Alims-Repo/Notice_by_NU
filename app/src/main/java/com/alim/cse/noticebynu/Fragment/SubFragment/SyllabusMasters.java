...
public class SyllabusMasters extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_syllabus_masters, container, false);
        ...
        if (mData.isEmpty()) {
            ...
            new ParseURL().execute(Final.MASTERS());

            /*try {
                //new ParseURL().execute(Final.HONS());
                new GetArray().execute(getStringFromFile("/sdcard/Notice by NU/html/13.txt"));
            } catch (Exception e) {
                e.printStackTrace();
            }*/
            //new ParseURL().execute(Final.HONS());
